...
3. [Знакомство с node, npm. Верстка интерфейса с карточками, данные через mock объекты](https://github.com/DanilaNik/IU5_PSP2023/tree/main/lab2) [(Условие)](https://github.com/iu5git/JavaScript/blob/main/tutorials/lab3/README.md)
4. [Подключение к стороннему API (VK), Cors. Запросы XHR](https://github.com/DanilaNik/IU5_PSP2023/tree/main/lab4) [(Условие)](https://github.com/iu5git/JavaScript/blob/main/tutorials/lab4/README.md)
5. [Замена коллбеков на промисы и/или await. Запросы fetch](https://github.com/DanilaNik/IU5_PSP2023/tree/main/lab5) [(Условие)](https://github.com/iu5git/JavaScript/blob/main/tutorials/lab5/README.md)
